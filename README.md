...
Setup valid secrets to access the Google Sheets api by following the guides for:
    https://developers.google.com/sheets/api/guides/authorizing

Store the client secrets in a src/client_secret.json file
{
    "client_id": "your_id",
    "client_secret": "can_be_omitted_currently"
}
